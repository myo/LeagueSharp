...
namespace Challenger_Series.Plugins
{
    public class Ashe : CSPlugin
    {
        ...
        private void OnDraw(EventArgs args)
        {
            ...
            if (E.IsReady() && Orbwalker.ActiveMode != OrbwalkingMode.Combo && Orbwalker.ActiveMode != OrbwalkingMode.None && GameObjects.EnemyHeroes.Count(e=>e.Health > 1 && e.InAutoAttackRange()) == 0)
            {
